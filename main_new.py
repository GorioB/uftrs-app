...
from interface import statementwindow
import os
import datetime
...
class MainProgram(Frame,object):
	...
	def initUI(self):
		...
		self.notes['Statement of Cash Flows'] = statementwindow.StatementWindow(self.notes['Statement of Cash Flows'],self.app,deletedVar=self.showDeleted)
